  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log('Productos is array:', Array.isArray(productosData));
        console.log('Categorías is array:', Array.isArray(categoriasData));
                    ...
                    {producto.imagen ? (
                      <img
                        ...
                        onError={(e) => {
                          ...
                          console.log('URL construida:', getImageUrl(producto.imagen));
                        }}
                      />
                    ) : (
